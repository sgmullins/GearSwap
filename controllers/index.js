...
module.exports = {
	...
	async putForgotPw(req, res, next) {
		...
		const msg = {
			to: user.email,
			from: 'GearSwap Admin <sgmullins@gmail.com>',
			subject: 'Gear Swap - Forgot Password / Reset',
	...
	async putReset(req, res, next) {
		...
		// there is a bug in this Code- if user enters a new PW that is the same as old it hangs
		...
		const msg = {
			to: user.email,
			from: 'GearSwap Admin <sgmullins@gmail.com>',
			subject: 'Gear Swap - Password Changed',
			text: `Hello,
